  ...
  return (
    <div className="bg-[rgb(var(--card))] rounded-xl shadow-md p-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="font-bold text-[rgb(var(--text))]">Upcoming Event</h3>
          <p className="text-xs text-[rgb(var(--text-secondary))]">Next scheduled</p>
        </div>
      </div>
      ...
      {upcomingEvent ? (
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <h4 className="font-semibold text-[rgb(var(--text))] truncate">{eventTitle}</h4>
            ...
            {upcomingEvent.description && (
              <>
                <h5 className="font-sm text-[rgb(var(--text))]">Description:</h5>
                <p className="text-sm text-[rgb(var(--text-secondary))] line-clamp-2">{upcomingEvent.description}</p>
              </>
            )}
          </div>
          ...
          <Link
            to="/calendar"
            className="block w-full px-4 py-2 text-center bg-rose-600 hover:bg-rose-700 text-[rgb(var(--text))] rounded-lg transition font-medium text-sm"
          >
            View in Calendar
          </Link>
        </div>
        ...
        <div className="h-64 flex items-center justify-center">
          <div className="text-center">
            <Calendar className="w-12 h-12 mx-auto mb-3 text-[rgb(var(--text-secondary))]" />
            <p className="text-[rgb(var(--text-secondary))] text-sm mb-3">No upcoming events</p>
            <Link
              to="/calendar"
