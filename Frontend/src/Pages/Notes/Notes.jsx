...
import { Search, Calendar, BookOpen, SortAsc, SortDesc } from 'lucide-react';
...
function Notes() {
  ...
  const filteredNotes = useMemo(() => {
    ...
    return filtered;
  }, [notes, searchQuery, selectedSubject, sortBy, sortOrder]);
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition cursor-pointer"
                >
